 ...
 *
 * TODO(review): needs document snapshots to diff against, so it depends on
 * persistence landing first. Findings from grading, DXF validation and the
 * checks here should all surface as the shared `Diagnostic` in `@/diagnostics`.
 * See DEVELOPMENT.md.
 */
