 ...
 *
 * TODO(fit): the whole workspace is stubs. It is the cheapest of the five to
 * make real, because `MeasurementLink` and `evaluateMeasurements` already exist
 * in `@/pattern` — Fit mostly needs a UI over them plus a body-measurement
 * table to compare against. See DEVELOPMENT.md.
 */
